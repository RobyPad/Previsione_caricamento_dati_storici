...
{	
	...
	public List<Partita> caricaCampionati_old(List<String> campionati, List<String> bottoni) 
	{
		// Lista da ritornare
			...
			for (Element e : childSportNameSoccer) 
			{
				...
				else
				{
					...
					else
					{
								...
								Partita p = new Partita(id_composto, nazione, competizione, turno, annata, data, ora, squadraCasa, goalCasa, squadraTrasferta, goalTrasferta,risultato);
